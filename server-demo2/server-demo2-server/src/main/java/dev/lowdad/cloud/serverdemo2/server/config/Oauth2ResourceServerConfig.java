...
public class Oauth2ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    private final static String resourceId = "demo2";
    ...
    @Autowired
    public Oauth2ResourceServerConfig(JwtSignConfiguration jwtSignConfiguration, RedisConnectionFactory redisConnectionFactory) {
